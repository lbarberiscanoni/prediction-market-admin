...
<!-- Admin dashboard for managing markets, users, and analytics. -->
...
### July 16, 2025
- Update test market creation to include close date
...
### July 6, 2025
- Add page to view FRED data

### July 1, 2025
- Create debug component for viewing active users
